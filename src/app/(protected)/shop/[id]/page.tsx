 ...
 *
 * Server Component. Loads a single product by ID.
 * Returns 404 if the product is not found or inactive.
 * Renders a full-page product view with an AddToCartSection client wrapper.
 */
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        >
          {product.image_url ? (
            ...
            <div className="flex h-full min-h-[360px] w-full items-center justify-center">
              <Package
                className="size-24 text-brand-gray opacity-30"
                strokeWidth={1}
              />
            </div>
          )}
        ...
        <div className="flex flex-col gap-6">
          ...
          {product.category && (
            <div>
              <Badge className="font-condensed text-xs uppercase tracking-wide-display">
                {product.category}
              </Badge>
            </div>
          )}
          ...
          >
            ...
            <span className="font-condensed text-3xl font-extrabold tracking-display text-foreground">
          ...
          {product.stock !== undefined && product.stock !== null && (
            <p
              className={cn(
                'font-condensed text-xs uppercase tracking-wide-display',
                product.stock > 0
                  ? 'text-emerald-500'
                  : 'text-destructive',
              )}
